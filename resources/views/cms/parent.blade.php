...
<head>
    ...
    <title> CMS PROJECT final | @yield('title') </title>
          ...
          @endif
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"> {{--{{ route('edit-profile-admin') }}  --}}
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"> {{--{{ route('change_password') }}  --}}
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">{{--{{ route('view.test') }}  --}}
